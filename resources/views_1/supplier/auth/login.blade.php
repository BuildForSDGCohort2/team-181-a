@extends('layouts.auth', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Material Dashboard')])
  ...
  <div class="row align-items-center">
    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      {{-- <form class="form" method="POST" action="{{ route('login') }}"> --}}
        <form method="POST" action="{{ route('supplier.login') }}" aria-label="{{ __('Login') }}">
            @csrf
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body">
            <p class="card-description text-center">{{ __('Welcome...') }}</p>
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-success btn-link btn-lg">{{ __('Lets Go') }}</button>
          </div>
        </div>
      </form>
      <div class="row">

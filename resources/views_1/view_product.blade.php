@extends('layouts.shop', ['activePage' => 'onsale', 'titlePage' => __('On Sale')])
...
<section class="mb-5" style="background: #f0f0f0">
    ...
    <div class="row" style="width: 70%; margin: auto;">
                ...
                <div class="row product-gallery mx-1">
                    ...
                    <div class="col-12 mb-0">
                        <figure class="view overlay rounded z-depth-1 main-img">
                            <a href="{{ asset('material') }}/img/default.jpg"
                                data-size="710x823">
                                <img src="{{ asset('material') }}/img/default.jpg"
        ...
        <div class="col-md-6" style="margin-top: 100px">
            ...
            <p class="mb-2 text-muted text-uppercase small">Item A</p>
            <ul class="rating">
                <li>

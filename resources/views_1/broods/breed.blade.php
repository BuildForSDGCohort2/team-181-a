@extends('layouts.app', ['activePage' => 'animal-breed', 'titlePage' => __('Typography')])
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header card-header-primary">
        <h4 class="card-title">Specific Breed</h4>
        <p class="card-category">This page will display the specific Breed And its informtion</p>
      </div>
      <div class="card-body">
        <div id="typography">

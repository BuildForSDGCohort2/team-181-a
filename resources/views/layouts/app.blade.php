...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="{{ $class ?? '' }}">
        ...
        <script  type="application/javascript" src="{{ asset('material') }}/js/core/bootstrap-material-design.min.js"></script>
        <script  type="application/javascript" src="{{ asset('material') }}/js/plugins/perfect-scrollbar.jquery.min.js"></script>
        ...
        <script  type="application/javascript" src="{{ asset('material') }}/js/plugins/bootstrap-datetimepicker.min.js"></script>
        ...
        <script  type="application/javascript" src="{{ asset('material') }}/js/material-dashboard.js?v=2.1.1" type="text/javascript"></script>

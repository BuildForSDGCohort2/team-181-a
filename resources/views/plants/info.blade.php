@extends('layouts.app', ['activePage' => 'plants-info', 'titlePage' => __('Typography')])
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header card-header-primary">
        <h4 class="card-title">This will Display the spcific info About a specific Breed of animal.</h4>

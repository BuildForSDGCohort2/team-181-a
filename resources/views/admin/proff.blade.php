    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
          ...
          @csrf
            <div class="first-column" style='width:45%; float: left;'>
              <div class="form-group">
                ...
                <input type="text" class="form-control" v-model='users.name'id="name" aria-describedby="name" placeholder="Enter Your Full names" required>
                <small id="type" class="form-text text-muted">As they appear on the id.</small>
              </div>
               <div class="form-group">
                <label for="strain">Id number</label>
                <input type="text" v-model ='users.id_number'class="form-control" id="id_number" aria-describedby="idnumber" placeholder="XXX-XXX" required>
                <small id="idnnumber" class="form-text text-muted">Enter Id number</small>
              </div>
              <div class="form-group">
                <label for="strain">Phone number</label>
                <input type="text" v-model ='users.phone'class="form-control" id="phone" aria-describedby="phonenumber" placeholder="07XX-XXX-XXX" required>
            ...
            <div class="form-group">
              ...
              <input type="text" v-model ='users.other'class="form-control" id="other" aria-describedby="other" placeholder="Enter The Specialty">
              <small id="other" class="form-text text-muted">Please Specify </small>
            </div>
            <div class="form-group">
              <label for="location">Location</label>
              <input type="text" v-model ='users.location'class="form-control" id="location" aria-describedby="loc" placeholder="eg. Nakuru.." required>
            ...
            {{-- this input shoulf be inactive if the specialty selected is not other --}}
              ...
              <div class="form-group">
                ...
                <input type="email" v-model ='users.email'class="form-control" id="email" aria-describedby="mail" placeholder="abc@xyz.com" required>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" v-model='users.exp' id="exp" aria-describedby="expirience" placeholder="0">
        ...
        <div class="modal-footer">
          <button @click="save_item((users.decision == 'approve') ? 'confirmation/' + users.id :  'rejection/' + users.id )" class="btn btn-info" value="Submit">Submit</button>

@extends('layouts.app', ['activePage' => 'animal-show', 'titlePage' => __('Typography')])
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header card-header-primary">
          {{--  this pagae will display the specific animal all about it
            offsprings weight health history etc --}}
        <h4 class="card-title">Name  Of The pecific animal</h4>
        <p class="card-category">A 'X' year 'gender' 'Breed' ...</p>
      </div>
      <div class="card-body">
        <div id="typography">

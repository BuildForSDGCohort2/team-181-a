    ...
    <div class="row justify-content-center">
      <div class="col-lg-3 col-md-12 text-center " style="border:1px solid white; border-radius: 25px; margin:0.1px; ">
        ...
        <a href="/professionals">
          <button class="btn btn-outline" style="border: 1px solid white; color: white; white-space: normal; "><i
              class="fa fa-search" aria-hidden="true"></i> Hire A <span
      ...
      <div class="col-lg-3 col-md-12 text-center " style="border:1px solid white; border-radius: 25px; margin:0.1px;">
        ...
        <p style="padding-top: 20%">
          ...
          When The produce is ready the farmer will get a Notification from the system alerting him/her to this very
          fact.
          If comfortable the farmer will confirm the notification, and the system will automatically post the product
          for sale.
        </p>
        <button class="btn btn-outline"
          style="border: 1px solid white; color: white; white-space: normal;margin-bottom:20px; " data-toggle="modal"
          data-target="#farmers_modal" style="float: right;"> <i class="material-icons">person_add</i> Register as A
          <span style="color: greenyellow">Farmer</span> </button>
      ...
      <div class="col-lg-3 col-md-12 text-center " style="border:1px solid white; border-radius: 25px;margin:0.1px; ">
        ...
        <a href="/suppliers">
          <button class="btn btn-outline" style="border: 1px solid white; color: white;white-space: normal; "> <i
              class="material-icons">sync</i> Browse for <span style="color: rgb(243, 162, 12)">Suppliers</span>
          </button>
          <p style="padding-top: 20%">
        </a>

        Suppliers Too can enroll in this system. The system will coodinate the Buying of thr various farm inputs needed.
        the farmer will only worry about the farm, all the logistics wil be handled by his 'Assistant'.
        </p>
        <button class="btn btn-outline" style="border: 1px solid white; color: white; white-space: normal; "
          data-toggle="modal" data-target="#supplier_modal" style="float: right;"> <i
            class="material-icons">person_add</i> Register as A <span style="color: rgb(255, 179, 0)">supplier</span>
        </button>
        ...
        <form action="{{route('suppliers_enrole')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="first-column" style='width:45%; float: left;'>
            ...
            <div class="form-group">
              ...
              <input type="text" v-model='form.location' class="form-control" id="location" aria-describedby="loc"
            ...
            <div class="form-group">
              ...
              <input type="text" v-model='form.phone_number' class="form-control" id="phone_number" aria-describedby="pnumber"
          ...
          <div class="second-column" style='width:45%; float: right;'>
            ...
            <div class="custom-file">
              <input type="file" class="custom-file-input" id="kra" v-model='form.kra' required>
          ...
          <div class="modal-footer">
            <button @click="save_item('suppliers_enrole')" class="btn btn-info" value="Submit">Submit</button>
        ...
        <form action="{{route('profesionals_enrole')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="first-column" style='width:45%; float: left;'>
            ...
            <div class="form-group">
              ...
              <input type="text" v-model='form.id_number' class="form-control" id="id_number" aria-describedby="idnumber"
                placeholder="XXX-XXX" required>
            ...
            <div class="form-group">
              ...
              <input type="text" v-model='form.other' class="form-control" id="other" aria-describedby="other"
          ...
          <div class="second-column" style='width:45%; float: right;'>
            ...
            <div class="form-group">
              ...
              <small id="expirience" class="form-text text-muted">Please indicate the Number of years of Experience
                .</small>
            </div>

            {{-- file uploader --}}
            <div class="custom-file">
              <input type="file" class="custom-file-input" v-model="form.file" id="file" required>
            ...
            <div class="form-group">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="agre" v-model="form.agre" required>
                <label class="custom-control-label" for="agre"> Agree to <a href="#" class="text-primary">terms and
                    conditions</a> </label>
              </div>
            </div>
          </div>
          ...
          <div class="modal-footer">
            <button  @click="save_item('profesionals_enrole')" class="btn btn-info" value="Submit">Submit</button>
            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
          </div>
        ...
        <form action="{{route('farmers_enrole')}}" method="POST">
          ...
          <div class="second-column" style='width:32%; float: left;margin-right:1%'>
            ...
            <div class="form-group">
              ...
              <input type="text" v-model='form.size' class="form-control" id="size" aria-describedby="size"
                placeholder="optional">
              <small id="size" class="form-text text-muted">Farm Size..</small>
            </div>
            <label>Calibration in:</label><br>
            <input type="radio" v-model="form.callibration" id="meters" value="meters" />
            <label for="meters">M &sup2; </label>

            <input type="radio" v-model="form.callibration" id="acres" value="acres" />
            <label for="acres">Acr</label>

            <input type="radio" v-model="form.callibration" id="hactares" value="hactares" />
            <label for="hactares">Ha</label>
            <label>Check Where Appropriate:</label><br>
            {{--  must check on e of these--}}
            <div class="form-group">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="animals" v-model="form.fields[animal]">
                <label class="custom-control-label" for="animals"> Animals</label>
              </div>
            </div>
            <div class="form-group">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="crops" v-model="form.fields[crops]">
            ...
            <div class="form-group">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="poultry" v-model="form.fields[poultry]">
          ...
          <div class="third-column" style='width:32%; float: right;margin-right:1%'>
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" v-model='form.password' id="password" aria-describedby="password"
            ...
            <div class="form-group">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="agr" v-model="form.agr" required>
                <label class="custom-control-label" for="agr"> Agree to <a href="#" class="text-primary">terms and
                    conditions</a> </label>
              </div>
            </div>
          </div>
          <div class="modal-footer">
            <button  @click="save_item('farmers_enrole')" class="btn btn-info" value="Submit">Submit</button>
            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
          </div>
          <input type="hidden" id="reg_type" v-model="form.reg_type" value="farmer">
        </form>
      </div>
    </div>
  </div>

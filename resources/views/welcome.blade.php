  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-3 col-md-12 text-center " style="border:1px solid white; border-radius: 25px; margin:0.1px; ">
          ...
          <button class="btn btn-outline" style="border: 1px solid white; color: white; white-space: normal; " data-toggle="modal" data-target="#professional_modal" style="float: right;"> <i class="material-icons">person_add</i> Register as A <span style="color: rgb(255, 179, 0)">proffessional</span> </button>
      ...
      <div class="col-lg-3 col-md-12 text-center " style="border:1px solid white; border-radius: 25px; margin:0.1px;">
        ...
        <button class="btn btn-outline" style="border: 1px solid white; color: white; white-space: normal;margin-bottom:20px; " data-toggle="modal" data-target="#farmers_modal" style="float: right;"> <i class="material-icons">person_add</i> Register as A <span style="color: greenyellow">Farmer</span> </button>
      ...
      <div class="col-lg-3 col-md-12 text-center " style="border:1px solid white; border-radius: 25px;margin:0.1px; ">
        ...
        <button class="btn btn-outline" style="border: 1px solid white; color: white; white-space: normal; " data-toggle="modal" data-target="#supplier_modal" style="float: right;"> <i class="material-icons">person_add</i> Register as A <span style="color: rgb(255, 179, 0)">supplier</span> </button>
      ...
      <form action="{{route('suppliers_enrole')}}" method="POST">
          ...
          <div class="first-column" style='width:45%; float: left;'>
            <div class="form-group">
              ...
              <input type="text" class="form-control" name='name'id="name" aria-describedby="name" placeholder="enter business name" required>
            ...
            <div class="form-group">
              ...
              <input type="text" name ='phone_number'class="form-control" id="phone_number" aria-describedby="pnumber" placeholder="XXX-XXX" required>
          ...
          <fieldset>
            ...
            <div class="form-group">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" name="agree" class="custom-control-input" id="agree" name='agree'required >

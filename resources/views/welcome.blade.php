  ...
  <div class="container">
    <div class="row justify-content-center">
      ...
      <div class="col-lg-3 col-md-12 text-center " style="border:1px solid white; border-radius: 25px; margin:0.1px;">
        ...
        <a href="{{ route('register') }}">
          <button class="btn btn-outline" style="border: 1px solid white; color: white;white-space: normal; margin-bottom:15%; "> <i class="material-icons">person_add</i> Register as A <span style="color: greenyellow">farmer</span> </button> 
        </a>
      </div>
      <div class="col-lg-3 col-md-12 text-center " style="border:1px solid white; border-radius: 25px;margin:0.1px; ">
      ...
      <form action="" method="POST">
        @csrf
          ...
          <div class="second-column" style='width:45%; float: right;'>
            ...
            <label class="custom-file-label" for="validatedCustomFile">Upload <span class="text-danger">KRA</span>  Cert</label>
      ...
      <form action="" method="POST">
        @csrf
          ...
          <div class="form-group">
            ...
            <input type="text" name ='size'class="form-control" id="size" aria-describedby="size" placeholder="Enter The Specialty">

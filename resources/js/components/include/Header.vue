...
<v-app id="inspire">
        ...
        <v-list dense id="navigation">
            ...
            <template>
                <v-card>
                    ...
                    <router-link to="/animals" class="v-list-item v-list-item--link theme--light">
                        <div class="v-list__tile__action">
                    ...
                    <router-link to="/plantation" class="v-list-item v-list-item--link theme--light">
                        <div class="v-list__tile__action">
                            <v-icon>mdi-tree-outline</v-icon>
                        </div>
                        <div class="v-list-item__content">
                            <div class="v-list-item__title">Plantation</div>
                        </div>
                    </router-link>
    ...
    <v-footer style="background: #e2e0e0 !important;" app>
        <span style="color: #000; margin: auto;">Farmer &copy; {{ new Date().getFullYear() }}</span>
    </v-footer>
</v-app>
</template>
